    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 mb-3">
                    {!! Form::label('table-akar-normalisasi', '3. Pembagian Hasil Akar Nilai Normalisasi dengan
                    normalisasi matrik:') !!}
                    <div class="table-responsive">
                        <table class="table table-bordered" id="table-akar-normalisasi">
                            ...
                            <tbody>
                                ...
                                App\Services\SmartTopsisService::verticalToHorizontal($result_normalized_root);
                                @endphp
                                @forelse ($alternatif_name as $key => $item)
                                <tr>
                                    <td>{{++$loop->index}}</td>
                ...
                <div class="col-sm-12 mb-3">
                    {!! Form::label('table-menentukan-hasil', '4. Menentukan Hasil normalisasi bobot:') !!}
                    <div class="table-responsive">
                        <table class="table table-bordered" id="table-menentukan-hasil">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Alternatif</th>
                            ...
                            <tbody>
                                @php
                                $verticalToHorizontal =
                                App\Services\SmartTopsisService::verticalToHorizontal($result_normalized_weight);
                                @endphp
                                @forelse ($alternatif_name as $key => $item)
                                <tr>
                                    <td>{{++$loop->index}}</td>
                ...
                <div class="col-sm-12 mb-3">
                    {!! Form::label('table-normalisasi-bobot', '5. Perhitungan Nilai Hasil Normalisasi Pembobotan:') !!}
                    <div class="table-responsive">
                ...
                <div class="col-sm-12 mb-3">
                    {!! Form::label('table-jarak-alternatif', '6. Jarak antara nilai setiap alternatif:') !!}
                    <div class="table-responsive">
                ...
                <div class="col-sm-12 mb-3">
                    {!! Form::label('table-rangking', '7. Hasil Perangkingan:') !!}
                    <div class="table-responsive">
...
<script>
    $(function () {
            ...
            $('#table-menentukan-hasil').DataTable()
        })
</script>
@endpush
